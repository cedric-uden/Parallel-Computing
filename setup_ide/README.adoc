...
:toclevels: 2
:leveloffset: 1
:toc-title: [big]#Inhaltsverzeichnis#
...
image::13-ssh_to_verify.png[SSH Verbindung mit Remote Host]

Anschließend navigieren wir zu dem aus Screenshot "<<img-step8>>" bekannten Pfad () und führen nun die Datei aus:

image::14-run_in_cmd_line_on_remote_host.png[CUDA Datei direkt auf Remote Host ausführen]
