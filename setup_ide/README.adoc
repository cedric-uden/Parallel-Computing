...
image::01-connect_vpn.png[VPN Verbindung mit Cisco AnyConnect, width=100%]
...
image::02-open_settings.png[Einstellungen in CLion öffnen, width=100%]
...
image::03-navigate_settings.png[Zu den richtigen Einstellungen navigieren, width=100%]
...
image::04-navigate_configure_host.png[SSH Identitäten Einstellung, width=100%]
...
image::05-configure_host_and_test_connection.png[SSH Identität konfigurieren, width=100%]
...
[#img-step5]
.Toolchains erkannt
image::06-verify_everything_found.png[Toolchains erkannt, width=100%]
...
image::07-verify_reloading_cmake.png[CMake Projekt wird geladen, width=100%]
...
[#img-step7]
.Run Configurations
image::10-view_run_configurations.png[Run Configurations, width=100%]
...
image::08-troubleshooting_01-reload_cmake.png[alt="Reload CMake Project", width=100%]
...
image::09-troubleshooting_02-invalidate_caches.png[alt="Invalidate Caches", width=100%]
+++ <br></div></details> +++
...
[#img-step8]
.CUDA Projekt Ausführen
image::11-run_hello_world_and_check_path.png[CUDA Projekt Ausführen, width=100%]
...
[#img-step8]
.Debugger starten
image::12-launch_debugger.png[Debugger starten, width=100%]
...
image::14-run_in_cmd_line_on_remote_host.png[CUDA Datei direkt auf Remote Host ausführen, width=100%]
